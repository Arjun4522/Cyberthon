...
<html lang="en">
  ...
  <body class="">
    <div class="wrapper auto_refresh">
      <div
        class="sidebar"
        data-color="purple"
            ...
            <div class="container">
              ...
              <div class="table">
                <div class="table-header">
                  <div class="header__item">Name</a></div>
                  <div class="header__item">Score</a></div>
                  <div class="header__item">Rank</a></div>
                </div>

                <!-- <div class="table-content">	
                  <div class="table-row">		
                    <div class="table-data" name="name">Tom</div>
                    <div class="table-data" name="score">2</div>
                    <div class="table-data" name="rank">0</div>
                  </div>
                </div> -->
                ...
                <div class="table-content">		
                    <?php
                      ...
                      $sql = "SELECT uname, score, rank FROM users ORDER BY score DESC";
                    ...
                    ?>
                  <div class="table-row">	
                    <div class="table-data" name="name"><?php echo $row['uname']; ?></div>
                    <div class="table-data" name="score"><?php echo $row['score']; ?></div>
                    <div class="table-data" name="rank"><?php echo $rank; ?></div>
                  </div>
                </div>
	...
	$("#" + val).click(function(e){
      ...
      $(function() {
        setInterval(function(){
          $('.auto_refresh').load('score board.php');
        },5000);
      });
    </script>
  </body>
